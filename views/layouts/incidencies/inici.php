...
<head>
    ...
    <style>
        ...
        .nav {
            position: fixed;
            /* Manté el menú fixe a la pantalla */
            left: 0;
            top: 0;
            height: 100%;
            width: 250px;
            /* Ample del menú lateral */
            background-color: #333;
        ...
        /* Classe per mostrar el menú lateral */
        .nav.active {
        ...
        .container {
            ...
            /* Animació de transició per al marge */
            margin-left: 0;
            /* Margin inicial */
        }
